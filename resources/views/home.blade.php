            ...
            <div class="white-box">
                <div class="row row-in">
                  <div class="col-lg-3 col-sm-6 row-in-br">
                      <div class="col-in row">
                          <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe016;"></i>
                              <h5 class="text-muted vb">ACTIVE PROJECTS</h5> </div>
                          <div class="col-md-6 col-sm-6 col-xs-6">
                              <h3 class="counter text-right m-t-15 text-success">{{$activeProjects}}</h3> </div>
                  ...
                  <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                      <div class="col-in row">
                          <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                              <h5 class="text-muted vb">ASSIGNED TASKS</h5> </div>
                          <div class="col-md-6 col-sm-6 col-xs-6">
                              <h3 class="counter text-right m-t-15 text-megna">{{ $tasksAsigned }}</h3> </div>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6 row-in-br">
                        <div class="col-in row">
                            <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                <h5 class="text-muted vb">MY <br>FRIENDS</h5> </div>
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 class="counter text-right m-t-15 text-danger">{{count($actualUser->friends()->get())}}</h3> </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6  b-0">
                        <div class="col-in row">
                            <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
                                <h5 class="text-muted vb">ASSIGNED<br> PROJECTS</h5> </div>
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <h3 class="counter text-right m-t-15 text-primary">{{$assignedProjects}}</h3> </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="progress">
                    ...
                    <div class="bg-theme-dark m-b-15">
                        <div class="row weather p-20">
                            ...
                            <div class="col-md-6 col-xs-6 col-lg-6 col-sm-6 text-right"> <i class="wi wi-day-cloudy-high"></i>
                                <br/>
                                <br/>
                                <b class="text-white">{{$weather[0]['WeatherText']}}</b>
